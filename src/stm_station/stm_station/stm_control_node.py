...
class STMControlNode(Node):
    def __init__(self):
        ...
        # variables
        # value = self.get_parameter('param_name').get_parameter_value().type
        ...
        self.slave_state_topic = f"/group_{self.slave_group_id}/stm_state" # Master stm_state topic (/group_id/stm_state)
        ...
        self.master_stm_state_subscriber = self.create_subscription(
            STMState,             # Message type used by the publisher
            self.master_state_topic,  
            self.master_stm_state_callback,  
            10)  # Subscriber for the master node state
        ...
        self.slave_stm_control_publisher = self.create_publisher(
            ...
            10)  # Publisher for the slave node control
        ...
        self.control_type_service = self.create_service(STMSetControlType, self.control_type_service_name, self.service_control_type_callback)
    ...
    def slave_stm_state_callback(self, msg):
        ...
        :param msg: STMState message containing motor position data.
        """
        # TODO: Update slave_position with value from msg
