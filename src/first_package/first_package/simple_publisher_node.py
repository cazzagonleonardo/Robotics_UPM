...
class MinimalPublisher(Node):
    def __init__(self):
        ...
        # self.publisher_ = self.create_publisher(PointCloud2, 'topic_1', 10)  # <-- EXERCISE 1
        self.publisher_ = self.create_publisher(ExampleMessage, 'topic_1', 10)  # <-- EXERCISE 2
    ...
    def timer_callback(self):
        ...
        # msg = PointCloud2() # <-- EXERCISE 1
        msg = ExampleMessage() # <-- EXERCISE 2
        ...
        # msg.width = 10 + self.i # <-- EXERCISE 1
        # msg.height = 20 + 2*self.i # <-- EXERCISE 1
        msg.my_float = 0.0 + self.i # <-- EXERCISE 2
        msg.my_float_array = [1.0, 2.0 + self.i] # <-- EXERCISE 2
        msg.my_string = f"Hi Federico #{self.i}" # <-- EXERCISE 2

        # Publish the message
        self.publisher_.publish(msg)
        
        # Log the published message to the console
        # self.get_logger().info(f'Publishing: "Width pointcloud = {msg.width} and Height pointcloud = {msg.height}"') # <-- EXERCISE 1
        self.get_logger().info(f'Publishing: "my_float = {msg.my_float}; my_float_array = {msg.my_float_array}; my_string = {msg.my_string}"') # <-- EXERCISE 2
